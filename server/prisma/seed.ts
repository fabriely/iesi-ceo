  ...
  await prisma.medicalRecord.createMany({
    data: [
      ...
      },
      {
        ...
        clinicExam: ['RADIOGRAFIA_PANORAMICA', 'TRATAMENTO_POR_ALTA_POTENCIA_FLUORETOS_NA_MUCOSA_ORAL'],
      },
      {
      ...
      },
      {
        ...
        clinicExam: ['TRATAMENTO_POR_ALTA_POTENCIA_FLUORETOS_NA_MUCOSA_ORAL', 'RESTAURACAO_DE_DENTE_PERMANENTE_ANTERIOR_COM_RESINA_COMPOSTA'],
      },
      {
      ...
      },
      {
        ...
        clinicExam: ['MOLDAGEM_DENTAL_MAXILAR_PARA_CONSTRUCAO_DE_PROTESE_DENTA', 'PROTESE_TOTAL_MAXILAR'],
      },
      {
      ...
      },
      {
        ...
        clinicExam: ['RADIOGRAFIA_INTERPROXIMAL_BITE_WING', 'TRATAMENTO_POR_ALTA_POTENCIA_FLUORETOS_NA_MUCOSA_ORAL'],
      }
